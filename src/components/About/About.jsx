...
const About = () => {
  return (
    <div className="w-full h-screen bg-bg-color px-4 sm:px-0 items-center grid sm:grid-cols-1 sm:px-2 md:grid-cols-1 md:px-5 lg:grid-cols-2 lg:px-10 xl:grid-cols-2 xl:px-40">
