...
const About = () => {
  return (
    <div className="w-full h-screen bg-bg-color flex flex-col lg:flex-row gap-8 lg:gap-14 justify-center items-center px-8 lg:px-40">
      <div className="left-about text-center lg:text-left">
        <div className="content items-center gap-8 mb-8 lg:mb-16">
          <div className="heading">
            <p className="text-primary-color font-mono text-sm md:text-base">
              01. WHO AM I
            </p>
            <h1 className="text-cream-white font-main text-2xl md:text-3xl lg:text-4xl font-semibold mt-3">
              About Me
            </h1>
          </div>
          <div className="line mt-3 w-32 md:w-40 lg:w-60 h-1 rounded-xl bg-line-color mx-auto lg:mx-0"></div>
        </div>
        <div className="about-para text-cream-white font-medium text-sm md:text-base lg:text-xl leading-relaxed">
